...
<head>
    ...
    <?php
    // RankMath owns the <head> SEO (title, description, OG, canonical, robots)
    // on every page including this LP front page; values come from the front
    // page's rank_math_* post meta (seeded), not the theme.
    wp_head();
    ?>
</head>
<body <?php body_class(); ?>>
